...
exports.customer = async (req, res) => {
	...
	db.User.create(req.body)
		.then((data) => dataResponse(res, data, 'Customer has been registered', 'Customer was not registered'))
...
exports.restaurant = async (req, res) => {
	...
	db.Restaurant.create(req.body)
		.then((data) => dataResponse(res, data, 'Restaurant has been registered', 'Restaurant was not registered'))
		.catch((err) => errResponse(res, err));
};
...
exports.restoAdmin = async (req, res) => {
	...
	req.body.password = await bcrypt.hash(req.body.password, parseInt(process.env.SALT_ROUND));
	db.User.create(req.body)
		.then((data) => dataResponse(res, data, 'Resto Admin has been registered', 'Resto Admin was not registered'))
		.catch((err) => errResponse(res, err));
};
...
exports.admin = async (req, res) => {
	...
	req.body.password = await bcrypt.hash(req.body.password, parseInt(process.env.SALT_ROUND));
	db.User.create(req.body)
		.then((data) => dataResponse(res, data, 'Admin has been registered', 'Admin was not registered'))
		.catch((err) => errResponse(res, err));
};
